...
function handleGenerate() {
    ...
    // You can access the parsed data via arrayDataJSON
    // Example: arrayDataJSON[1] contains data from first file
    
    alert(`Ready to generate with ${uploadedFiles.length} file(s)!`);
}
